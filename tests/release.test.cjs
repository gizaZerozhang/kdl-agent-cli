...
function candidate(t, version = '0.1.0-beta.1') {
  ...
  const pkg = { name: '@zerozhang-giza/kdl-agent', version, repository: { url: 'git+https://github.com/gizaZerozhang/kdl-agent-cli.git' } };
  ...
  const record = { version, repository: 'gizaZerozhang/kdl-agent-cli', commit: 'b'.repeat(40), dirty: false, macosSigned: false, sha256: crypto.createHash('sha256').update(sums).digest('hex') };
